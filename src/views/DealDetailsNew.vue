...
.border-none .vs-con-input input {
...
.border-bottom .border-none .vs-con-input input {
    /* border-bottom: 1px solid #00a551 !important; */
    border-bottom: 1px solid #eaeaea !important;
    border-radius:0 !important;
}

.border-bottom .border-none .vs-con-input input:focus {border-bottom: 1px solid #00a551 !important;color: #333 !important;}

.border-bottom .border-none .vs-con-input::after {content: "\e866";width: 20px;height: 20px;display: block;position: absolute;right: 0;color: #cacaca;/* background: #333; */z-index: 1111;font-family: feather!important;bottom: 6px;/* font-family: Material; */font-size: 1.1rem;}

.border-bottom .border-none:hover .vs-con-input::after {
    color: #636363;
}
